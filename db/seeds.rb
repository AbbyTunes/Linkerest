...
file1 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/home1.jpeg")
pin1.photo.attach(io: file1, filename: "home1")
pin1.save!

pin2 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file2 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/home4.jpeg")
pin2.photo.attach(io: file2, filename: "home4")
pin2.save!

pin3 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file3 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/home2.jpeg")
pin3.photo.attach(io: file3, filename: "home2")
pin3.save!

pin4 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file4 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/home7.jpeg")
pin4.photo.attach(io: file4, filename: "home7")
pin4.save!

pin5 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file5 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/hair4.jpeg")
pin5.photo.attach(io: file5, filename: "hair4")
pin5.save!

pin6 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file6 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/cat2.jpeg")
pin6.photo.attach(io: file6, filename: "cat2")
pin6.save!

pin7 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file7 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/cat4.jpeg")
pin7.photo.attach(io: file7, filename: "cat4")
pin7.save!

pin8 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file8 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/cat1.jpeg")
pin8.photo.attach(io: file8, filename: "cat1")
pin8.save!

pin9 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file9 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/cat3.jpeg")
pin9.photo.attach(io: file9, filename: "cat3")
pin9.save!

pin10 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file10 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/hair3.jpeg")
pin10.photo.attach(io: file10, filename: "hair3")
pin10.save!

pin11 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file11 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/home6.jpeg")
pin11.photo.attach(io: file11, filename: "home6")
pin11.save!

pin12 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file12 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/home5.jpeg")
pin12.photo.attach(io: file12, filename: "home5")
pin12.save!

pin13 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file13 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/home8.jpeg")
pin13.photo.attach(io: file13, filename: "home8")
pin13.save!

pin14 = Pin.new({ authorId: user1.id, link: "https://www.abbydeveloper.com/" })
file14 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/shoes2.jpeg")
pin14.photo.attach(io: file14, filename: "shoes2")
pin14.save!

pin15 = Pin.new({ authorId: user2.id, link: "https://www.abbydeveloper.com/" })
file15 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/seed8.jpg")
pin15.photo.attach(io: file15, filename: "seed8")
pin15.save!

pin16 = Pin.new({ authorId: user3.id, link: "https://www.abbydeveloper.com/" })
file16 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/seed7.jpg")
pin16.photo.attach(io: file16, filename: "seed7")
pin16.save!

pin17 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file17 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/seed1.jpg")
pin17.photo.attach(io: file17, filename: "seed1")
pin17.save!

pin18 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file18 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/project2.png")
pin18.photo.attach(io: file18, filename: "project2")
pin18.save!

pin19 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file19 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/project1.png")
pin19.photo.attach(io: file19, filename: "project1")
pin19.save!

pin20 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file20 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/project5.png")
pin20.photo.attach(io: file20, filename: "project5")
pin20.save!

pin21 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file21 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/project4.png")
pin21.photo.attach(io: file21, filename: "project4")
pin21.save!

pin22 = Pin.new({ authorId: demo_user.id, link: "https://www.abbydeveloper.com/" })
file22 = open("https://linkerest-pro.s3-us-west-2.amazonaws.com/project6.png")
pin22.photo.attach(io: file22, filename: "project6")
pin22.save!
